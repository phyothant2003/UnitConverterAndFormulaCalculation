    ...
    function calculateCircleCircumference(){
        ...
        rr2.innerHTML="Circle Circumference :"+result.toFixed(4)+" unit.";
        return true;
    } 
    ...
    function calculateArea(){
        ...
        var result=w*h;
        rr.innerHTML="Square Area :"+result.toFixed(4)+" square unit.";
        return true;
    } 
    ...
    function calculateRectangleArea(){
        ...
        var result=l*b;
        rla.innerHTML="Rectangle Area :"+result.toFixed(4)+" square unit.";
        return true;
    }
    ...
    function calculateTriangleArea(){
        ...
        var result=b*h*0.5;
        rta.innerHTML="Triangle Area :"+result.toFixed(4)+" square unit.";
        return true;
    }  
    ...
    function calculateTrapeziodArea(){
        ...
        rtpa.innerHTML="Trapeziod Area :"+result.toFixed(4)+" square unit.";
        return true;
    }  
    ...
    function calculateCircleArea(){
       ...
       ca.innerHTML="Circle Area :"+result.toFixed(4)+" square unit.";
        return true;
    }  
    ...
    function calculateCubeSurfaceArea(){
        ...
        var result=6*l*l;
       cb.innerHTML="Cube Surface Area :"+result.toFixed(4)+" square unit.";
        return true;
    } 
    ...
    function calculateCylinderSurfaceArea(){
       ...
       cc1.innerHTML="Cylinder Surface Area:"+result.toFixed(4)+" square unit.";
        return true;
    }  
    ...
    function calculateConeSurfaceArea(){
       ...
       ca2.innerHTML="Circle Area :"+result.toFixed(4)+" square unit.";
        return true;
    }  
    ...
    function calculateSphereSurfaceArea(){
       ...
       ca1.innerHTML="Sphere Surface Area :"+result.toFixed(4)+" square unit.";
        return true;
    } 
